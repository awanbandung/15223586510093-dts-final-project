...
const Popular = () => {
  ...
  let url = `${process.env.REACT_APP_GAMES_API_URL}/games?sort-by=popularity`;

  if (selectedCategory) {
    url = `${process.env.REACT_APP_GAMES_API_URL}/games?sort-by=popularity&category=${selectedCategory}`;
  }
